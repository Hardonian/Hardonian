...
Teams repeat manual sequences across files, scripts, and tools but never see the pattern clearly enough to automate it.

## Deliverable

Pattern audit, automation candidates, admin dashboard wiring, onboarding script, and recurring monitor setup.
