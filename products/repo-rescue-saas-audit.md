...
Builds fail, Stripe webhooks are unsafe, tenant isolation is weak, tests are missing, deployment is fragile.

## Deliverable

Repo health report, risk matrix, failing/passing checks, prioritized fix sprint plan.
