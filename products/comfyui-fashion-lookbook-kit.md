...
Lookbook generation is inconsistent and hard to turn into a clean reusable local pipeline.

## Deliverable

Txt2img + img2img + upscale workflow bundle, look presets, composition notes, prompt pack, sample folder structure.
